...
7. **`nextDay(state)` (`src/app.js`) est la seule porte d'entrée de la simulation** ; les actions joueur (`buy`, `sell`, `launchExp`, `acceptDelivery`, `deliverContract`, `payRansom`, `selectFaction`) sont les seules autres mutations.
